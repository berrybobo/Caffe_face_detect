...
def face_detection(imgFile):
    net_full_conv = caffe.Net( '/home/nuc/fade_detect/deploy_full_conv.prototxt',
                               '/home/nuc/fade_detect/alexnet_iter_50000_full_conv.caffemodel',
                              caffe.TEST)
    ...
    for scale in scales:
        ...
        cv2.imwrite('/home/nuc/face_detect/scale_img.jpg',scale_img)
        #scale_img.save("tmp{0}.jpg".format(randNum))
        # load input and configure preprocessing
        #im = caffe.io.load_image("tmp{0}.jpg".format(randNum))
        im = caffe.io.load_image('/home/nuc/face_detect/scale_img.jpg')
...
if __name__ == "__main__":
    imgFile = '/home/nuc/face_detect/timg.jpg'
